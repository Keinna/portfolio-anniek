var projects = [
    {
        ...
        paragraphs: [
            {
                ...
                content:
                    "In this case Axios is used to fetch image data from an external API endpoint (Unsplash API). The searchImages function takes a search term as an argument and returns a Promise that resolves to an array of image data. The axios.get method is used to make a GET request to the Unsplash API endpoint for searching photos, passing in the search term as a query parameter and an Authorization header with the client ID. The response data is then extracted from the response object and returned.",
            },
            {
                title: "SearchBar component",
                content:
                    "The SearchBar component renders a search bar with a label and input field. The component uses the useState hook to manage the state of the search term input field and the onSubmit prop to handle form submission. When the user submits the form (by pressing enter), the onSubmit function passed in as a prop is called with the current value of the search term input field.",
            },
            {
                title: "Background component",
                content:
                    "If there are no images to display, a background component is shown. This can help improve the user experience by preventing the page from appearing empty or unfinished.",
            },
            {
                title: "Image display",
                content:
                    "The images are displayed in a list format using a component called ImageList. The images are placed in a responsive grid.",
            },
        ],
        ...
        icons: [
            ...
            {
                src: "assets/img/sprite.svg#icon-visualstudiocode",
    ...
    },
    {
        ...
        icons: [
            ...
            { src: "assets/img/sprite.svg#icon-css3", alt: "CSS3 icon" },
            {
                src: "assets/img/sprite.svg#icon-javascript",
                alt: "Javascript icon",
            },
            { src: "assets/img/sprite.svg#icon-figma", alt: "Figma icon" },
            {
                src: "assets/img/sprite.svg#icon-bootstrap",
                alt: "Bootstrap icon",
            },
    ...
    {
        categories: "react",
        imageLink: "https://github.com/Keinna/books-react-app",
        ...
        paragraphs: [
            {
                ...
                content:
                    "This app is a book management tool built with React. It allows users to create, edit and delete books from a list. For now, every book gets a random generated image. The app uses React hooks like useState and useEffect to manage state. The app also uses reusable components like BookList, BookShow, BookEdit and BookCreate.",
            },
            {
                title: "BookCreate component",
                content:
                    "The BookCreate component is a functional component that takes in one prop: onCreate. The onCreate prop is a function that is called when the form is submitted. The component uses the useState hook to manage the state of the title input field. The initial value of the title state is an empty string. The handleChange function is called when the input field value is changed, and it sets the title state to the new value entered by the user.The handleSubmit function is called when the form is submitted. It prevents the default form submission behavior and calls the onCreate function passed in as a prop. The onCreate function takes in one argument: the new title value. The handleSubmit function calls the onCreate function with the title value to create a new book with the given title. It also sets the title state back to an empty string to clear the input field.",
            },
            {
                title: "BookEdit component",
                content:
                    "The BookEdit component is a functional component that takes in two props: book and onSubmit. The book prop is an object that represents the book to be edited, and onSubmit is a function that is called when the form is submitted. The component uses the useState hook to manage the state of the title input field. The initial value of the title state is set to the book.title value passed in as a prop. The handleChange function is called when the input field value is changed, and it sets the title state to the new value entered by the user.The handleSubmit function is called when the form is submitted. It prevents the default form submission behavior and calls the onSubmit function passed in as a prop. The onSubmit function takes in two arguments: the book.id and the new title value. The handleSubmit function calls the onSubmit function with these two arguments to update the book title.",
            },
            {
                title: "React hooks useState and useEffect",
                content:
                    'The useState hook is used to manage the state of the books array in the App component. The books array contains all the books that are displayed in the book list. Whenever a book is created, edited, or deleted, the setBooks function updates the state of the books array. Using state in this project allows for the following functionality:\n\nCreating new books: \nWhen the user enters a title for a new book and clicks the "Create" button, the createBook function is called. This function creates a new book object with a unique id and the title entered by the user. It then adds the new book object to the existing books array and sets the updated array as the new state using the setBooks function. This allows the new book to be displayed in the book list.\n\nEditing existing books: \nWhen the user clicks the "Edit" button next to a book, the editBookByID function is called. This function updates the title field of the book with the given id. It then sets the updated books array as the new state using the setBooks function. This allows the edited book to be displayed in the book list with the updated title.\n\nDeleting existing books: \nWhen the user clicks the "Delete" button next to a book, the deleteBookById function is called. This function filters out the book with the given id from the books array and sets the updated array as the new state using the setBooks function. This allows the deleted book to be removed from the book list.\n\nThe useEffect hook is used to manage side-effects in functional React components. In this case, the useEffect hook is used to fetch the books data from the server when the component mounts. The fetchBooks function is called when the component mounts, and it sets the books state using the setBooks function. Since the useEffect hook has an empty dependency array, it will only be executed once, when the component first mounts.',
            },
        ],
        ...
        paragraphs: [
            {
                ...
                content:
                    "This badge will always be visible in the navigation. It shows the total amount of items in your cart. Thanks to local storage it will always show the right amount of items. One click brings you to the cart with the right amount of items and the right price.",
            },
            {
                title: "Checkout cart functionality",
                content:
                    "You can add or remove items. It is also possible to clear the whole cart at once. At the bottom of the cart you can see the total amount before you purchase.",
            },
            {
                title: "Loads data from 'database'",
                content:
                    "The data for the items is coming from a different file. This file mimicks a database. When you add data to the file, the JavaScript will display the right price, name, image and description in the store dynamically.",
            },
            {
                title: "Vanilla JavaScript project",
                content:
                    "However it would probably be easier to use a framework to set up a store. This project was a great way to practice my vanilla JavaScript skills.",
            },
        ],
    ...
    },
    {
        ...
        highlights: [
            "Webpack",
            "Animations on scroll (JavaScript)",
            "Dev dependencies",
            "Srcset",
        ],
        paragraphs: [
    ...
    },
    {
        ...
        highlights: [
            "Work/projects filter (JavaScript)",
            "Inner and outer shadow effects",
            "Shows loader/spinner animation",
            "BEM methodology",
        ],
        paragraphs: [
            {
    ...
    },
    {
        ...
        sourceCodeLink:
            "https://github.com/Keinna/social-media-dashboard-with-theme-switcher",
    },
];
